#!/bin/bash
#SBATCH --job-name=sqanti_isoquant_nodb
#SBATCH --cpus-per-task=10
#SBATCH --mem=32G
#SBATCH --output=sqanti_isoquant_nodb%j.out
#SBATCH --error=sqanti_isoquant_nodb%j.err
#SBATCH --time=3:00:00
#SBATCH --qos=short
set -e
...
ISO_GTF="/home/patroy/longseq/results/isoquant_results_no_db/$M/$M/$M.transcript_models.gtf"
...
COUNTS="/home/patroy/longseq/results/isoquant_results_no_db/$M/$M/$M.discovered_transcript_counts.tsv"
OUT_DIR="/home/patroy/longseq/results/sqanti_results_isoquant_nodb/$NAME"
